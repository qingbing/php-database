...
```
 - 101300101 : 数据库连接串"dsn"不能为空
 - 101300102 : 数据库连接失败
 - 101300103 : PDO连接数据库失败
 - 101300104 : PDO连接库"{className}"不存在
 - 101300201 : "{type}"查询参数不完整
 - 101300301 : "{type}"查询参数不完整
 - 101300302 : "{type}"查询参数不完整
 - 101300401 : "{type}"查询参数不完整
 - 101300501 : Find查询必须带有"table"参数
 - 101300502 : "offset"必须和"limit"配对出现
 - 101300601 : "Transaction"尚属未激活状态，不能执行"commit"和"rollback"操作
 - 101300602 : "Transaction"尚属未激活状态，不能执行"commit"和"rollback"操作
 - 101300701 : pagination 构建参数"sqlment"无效
```
